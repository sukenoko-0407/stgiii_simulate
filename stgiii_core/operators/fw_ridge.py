"""
Free-Wilson Ridge Operator for StageIII Simulator

古典的Free-Wilson線形モデル（リッジ回帰）による探索戦略
"""
...
class FreeWilsonRidgeOperator(BaseOperator):
    ...
    def fit(
        ...
        # Ridge回帰（fit_intercept=False: 設計行列にinterceptを含めているため）
